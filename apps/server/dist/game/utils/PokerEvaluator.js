...
export function resolveGangHand(pocketCards, communityCards) {
...
export function isHandBetterStrictly(handAPocket, handBPocket, communityCards) {
...
export function evaluateShowdownSequence(orderedPlayerHands, communityCards) {
    if (orderedPlayerHands.length <= 1)
        return true;
 ...
 */
export function generateTrueRanks(playerHands, communityCards) {
